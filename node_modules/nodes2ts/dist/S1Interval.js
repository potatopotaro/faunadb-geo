...
var S1Interval = (function (_super) {
     ...
     */
    S1Interval.prototype.expanded = function (radius) {
        // assert (radius >= 0);
        if (this.isEmpty()) {
            return this;
        }
        ...
        var lo = S2_1.S2.IEEEremainder(this.lo - (radius), 2 * S2_1.S2.M_PI);
        var hi = S2_1.S2.IEEEremainder(this.hi + (radius), 2 * S2_1.S2.M_PI);
        if (lo == (-S2_1.S2.M_PI)) {
            lo = (S2_1.S2.M_PI);
        }
    ...
    S1Interval.prototype.approxEquals = function (y, maxError) {
        ...
        return Math.abs(S2_1.S2.IEEEremainder(y.lo - (this.lo), 2 * S2_1.S2.M_PI))
            + (Math.abs(S2_1.S2.IEEEremainder(y.hi - (this.hi), 2 * S2_1.S2.M_PI)))
            <= (maxError);
    };
